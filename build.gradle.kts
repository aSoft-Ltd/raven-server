...
subprojects {
    ...
    configure<MavenPublishBaseExtension> {
        ...
        pom {
            ...
            url.set("https://github.com/aSoft-Ltd/raven-client")
            licenses {
                license {
                    name.set("MIT License")
                    url.set("https://github.com/aSoft-Ltd/raven-client/blob/master/LICENSE")
                }
            }
            developers {
                developer {
            ...
            scm {
                url.set("https://github.com/aSoft-Ltd/raven-client/")
                connection.set("scm:git:git://github.com/aSoft-Ltd/raven-client.git")
                developerConnection.set("scm:git:ssh://git@github.com/aSoft-Ltd/raven-client.git")
            }
        }
    }
}
